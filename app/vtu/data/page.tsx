...
export const metadata: Metadata = {
  title: 'Buy Data Bundles Online | Cheap Data Plans - Remopay',
  ...
  return (
    <main className="bg-white">
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900">Why Choose Remopay for Data?</h2>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-8 text-gray-600">Join millions of users enjoying fast data bundles on Remopay</p>
          <Link
            href="/auth/register"
