...
export const metadata: Metadata = {
  title: 'TV Subscription Online | DStv, GOtv, Startimes - Remopay',
  description: 'Renew or subscribe to DStv, GOtv, and Startimes through Remopay. Instant activation and flexible payment options.',
  ...
  return (
    <main className="bg-white">
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900">Why Subscribe with Remopay?</h2>
          </div>
