...
export const metadata: Metadata = {
  title: 'Buy Airtime Online | Fast & Cheap Airtime - Remopay',
  description: 'Buy airtime instantly for MTN, Airtel, Glo, and 9mobile at the best rates. Instant delivery and 24/7 availability on Remopay.',
  ...
  return (
    <main className="bg-white">
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900">Why Buy From Remopay?</h2>
          </div>
