...
export const metadata: Metadata = {
  title: 'Pay Bills Online | Electricity, Water & More - Remopay',
  description: 'Pay your electricity, water, and other utility bills online instantly through Remopay. Secure payment and instant confirmation.',
  ...
  return (
    <main className="bg-white">
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900">Why Pay with Remopay?</h2>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-8 text-gray-600">Make bill payments easy and convenient with Remopay</p>
          <Link
            href="/auth/register"
